    ...
    <div>
      <div className="UpcomingEvents-background" style={{ backgroundImage: `url(${backgroundImage})` }}>
        <nav className="nav-barUpcomingEvents">
          <div className="logo-containerUpcomingEvents" onClick={() => navigate('/')}>
          ...
          <div className="nav-linksUpcomingEvents">
            ...
            <div className="nav-iconsUpcomingEvents">
              <svg onClick={() => navigate('/cart')} xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none" className="nav-icon">
              ...
              <svg onClick={() => navigate('/signin')} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="nav-icon">
