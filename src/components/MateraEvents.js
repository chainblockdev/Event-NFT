// src/components/MateraEvents.js
    ...
    <>
      <div className="event-background">
        <nav className="nav-barEventDetail">
          ...
          <div className="nav-linksEventDetail">
            <a className="nav-linkEventDetail" href="/upcomingevents">Eventi</a>
      ...
      <div className="purchase-section-MateraEvents">
        ...
        <div className="purchase-buttons-MateraEvents">
          <button className="purchase-button primary-MateraEvents" onClick={handleAcquistaClick}>Acquista</button>
